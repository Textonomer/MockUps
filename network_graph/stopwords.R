# Function for adding stop words from a list
# for (w in splitwords) {
#   trimw <- trimws(w)
#   if (trimw != "" & trimw != ',') {
#     full_list <- paste0(full_list, "'",trimw, "',")  
#   }
# }

# TODO: Move these to being read from a text file for ease of access maybe
simpleStopWords <- c('the','of','and','to','in','that','a','it','be','as','by','for',
                     'is','his','this','was','with','which','not','i','at','he','d','but',
                     'or','all','we','they','an','their','have','so','them','from',
                     'de','then','were','are','on','there','our','upon','s',
                     'p','one','may','had','being','him','into',
                     'made','if','after','some','any','when','more','3','before','yet',
                     'will','said','been','also','e','no','you','very','those','these',
                     'such','c','who','st','1','two','out','l','where','much',
                     'though','n','lib','would','hath','what')
glasgowStopWords <- c('a','about','above','across','after','afterwards','again','against',
...
lextecStopWords <- c('a','about','above','across','after','again','against','all','almost',
                     ...
                     'fact','facts','far','felt','few','find','finds','first','for','four','from',
                     'full','fully','further','furthered','furthering','furthers','g','gave',
                     ...
                     'itself','j','just','k','keep','keeps','kind','knew','know','known','knows','l',
                     ...
                     'r','rather','really','right','right','room','rooms','s','said','same','saw','say','says',
                     ...
                     'so','some','somebody','someone','something','somewhere','state','states','still','still','such',
